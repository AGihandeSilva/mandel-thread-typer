...
public:
    ...
    using computeFunction = std::function<void (const ComputedDataSegment &, const bool &, int &, ComputeTaskResults &, int)>;
    ...
    void publishState(threadState state);
    void shareTask();
    ...
    colorMapStore &getColormap() const;
