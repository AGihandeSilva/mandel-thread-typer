...
public:
    ...
    bool performDynamicThreadOperation(RenderWorker* workerThread, dynamicThreadAction taskType);
...
private:
    ...
    std::array<int, MAX_NUM_WORKER_THREADS> waitingThreads {};
    std::array<bool, MAX_NUM_WORKER_THREADS> doneThreads {};
